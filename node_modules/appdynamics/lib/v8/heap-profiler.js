...
HeapProfiler.prototype.trackAllocations = function(duration, callback) {
  ...
  self.active = true;
    ...
    if(!self.active) return;
		...
		var builder = new AllocationGraphBuilder();
		var scanner = new JsonArrayScanner();
		var strings = {};
		...
		self.agent.appdNative.takeHeapSnapshot(function(chunk) {
			if(!stringsPart) {
	  ...
	  self.active = false;
  	self.agent.logger.log("V8 stopped tracking object allocations");
